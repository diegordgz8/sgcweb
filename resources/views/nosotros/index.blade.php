                              ...
                              <div class="p-4 md:w-1/3">
                                 <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                                    <div class="flex items-center mb-3">
                                       <div
                                          class="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-blue-500 text-white shrink-0">
                           ...
                           <div class="flex flex-wrap -m-4">
                              <div class="p-4 lg:w-1/2">
                                 <div
                                    ...
                                    <img alt="team"
                                       class="shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4"
