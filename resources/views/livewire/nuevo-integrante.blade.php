                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input wire:model.live="documento" type="text" name="documento" id="documento"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="s_nombre" class="block text-sm font-medium text-gray-700">Segundo
                                    nombre:</label>
                                <input wire:model.live="segundoNombre" type="text" name="s_nombre" id="s_nombre"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="s_apellido" class="block text-sm font-medium text-gray-700">Segundo
                                    apellido:</label>
                                <input wire:model.live="segundoApellido" type="text" name="s_apellido" id="s_apellido"
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input wire:model.live="email" type="text" name="email" id="email" autocomplete="email"
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="col-span-6 grid grid-cols-4">
                                @foreach ($listaEnfermedades as $item)
                                    <div>
                                        <input wire:model.live="enfermedades" type="checkbox" name="{{ $item->nombre }}"
                            ...
                            <div class="col-span-6 grid grid-cols-4">
                                @foreach ($listaMedicamentos as $item)
                                    <div>
                                        <input wire:model.live="medicamentos" type="checkbox" name="{{ $item->nombre }}"
                                            id="{{ $item->nombre }}" value="{{ $item->id }}"
                                            class="form-control">
                                        <label for="{{ $item->nombre }}"
                                            class=" text-sm font-medium text-gray-700">{{ $item->nombre }}</label>
